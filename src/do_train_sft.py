...
def main():
    ...
    model_args.model_name_or_path = "/opt/llm/input/dataset/THUDM/chatglm-6b"
    data_args.dataset_dir = "/opt/llm/input/dataset/chuanqing_data"
    f_list = os.listdir(data_args.dataset_dir)

    data_args.dataset = ",".join(f_list)
    training_args.output_dir = "/opt/llm/output"
    ...
    model, tokenizer = load_pretrained(model_args, training_args, finetuning_args, True, stage="sft")
